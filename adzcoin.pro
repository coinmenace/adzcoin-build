...
# Copyright (c) 2018 The Adzcoin developers
...
TARGET = adzcoin-qt
VERSION = 0.8.6.2
DEPENDPATH += /Users/adebayoolabode/desktop/projects/client/coins/perfectcore/ptc-mac/depends/x86_64-apple-darwin17.5.0
DEPS_INCLUDE=/Users/adebayoolabode/desktop/projects/client/coins/perfectcore/ptc-mac/depends/x86_64-apple-darwin17.5.0/include
DEPS_LIB=/Users/adebayoolabode/desktop/projects/client/coins/perfectcore/ptc-mac/depends/x86_64-apple-darwin17.5.0/lib
...
win32 {
    ...
    BOOST_INCLUDE_PATH=$$DEPS_INCLUDE
    BOOST_LIB_PATH=$$DEPS_LIB
    BDB_INCLUDE_PATH=$$DEPS_INCLUDE
    BDB_LIB_PATH=$$DEPS_LIB
    OPENSSL_INCLUDE_PATH=$$DEPS_INCLUDE
    OPENSSL_LIB_PATH=$$DEPS_LIB
    MINIUPNPC_INCLUDE_PATH=$$DEPS_INCLUDE
    MINIUPNPC_LIB_PATH=$$DEPS_LIB
    LIBPNG_INCLUDE_PATH=$$DEPS_INCLUDE
    LIBPNG_LIB_PATH=$$DEPS_LIB
    QRENCODE_INCLUDE_PATH=$$DEPS_INCLUDE
    QRENCODE_LIB_PATH=$$DEPS_LIB
...
isEmpty(BDB_INCLUDE_PATH) {
    macx:BDB_INCLUDE_PATH = $$DEPS_INCLUDE
}

isEmpty(BOOST_LIB_PATH) {
    macx:BOOST_LIB_PATH = $$DEPS_LIB
}

isEmpty(BOOST_INCLUDE_PATH) {
    macx:BOOST_INCLUDE_PATH = $$DEPS_INCLUDE
}
